...
const calculatorBtn = document.querySelector(".calculator"),
    spellingCheckerBtn = document.querySelector(".spelling-checker"),
    schoolEventsBtn = document.querySelector(".school-events"),
    goalTrackerBtn = document.querySelector(".goal-tracker"),
    noteTakerBtn = document.querySelector(".note-taker");

onAuthStateChanged(auth, (user) => {
    const loggedInUserId = localStorage.getItem("loggedInUserId");
    const authBtn = document.querySelector(".authentication");
    ...
    if (loggedInUserId) {
        ...
        getDoc(docRef).then((docSnap) => {
            if (docSnap.exists()) {
                ...
                authBtn.classList.replace("authentication", "sign-out");
...
spellingCheckerBtn.addEventListener("click", () => {
    window.location.href = "spelling-checker/spelling-checker.html";
});
